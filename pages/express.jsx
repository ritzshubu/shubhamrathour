    ...
    <div className='w-full'>
      <div className='w-screen h-[50vh] relative'>
        ...
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>Express NEWS</h2>
          <h3>PHP CMS/ MySQL/ SEO</h3>
        </div>
      </div>

      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          <p className='border-b border-gray-800 my-4'>
          ...
          <div>
            <ul>
              ...
              <li className='my-4'>
              RSS feeds gets updated every 24 hour. <br/>
              </li>

            </ul>
          </div>
          <a
            href='https://expressnewshindi.com/'
            target='_blank'
            rel='noreferrer'
          >
        ...
        <div className='col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl py-4'>
          <div className='p-2'>
            ...
            <p className='text-gray-600 py-2 flex items-center'>
              ...
              <p className='text-gray-600 py-2 flex items-center'>
                <RiRadioButtonFill className='pr-1' /> PWA
              </p>
              <p className='text-gray-600 py-2 flex items-center'>
                <RiRadioButtonFill className='pr-1' /> SEO Optimized
              </p>
              <p className='text-gray-600 py-2 flex items-center'>
                <RiRadioButtonFill className='pr-1' /> News Feed
              </p>
              <p className='text-gray-600 py-2 flex items-center'>
